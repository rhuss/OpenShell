...
use openshell_core::proto::{
    ...
    GetInferenceRouteResponse, InferenceRoute, InferenceRouteConfig, Provider, ResolvedRoute,
    Sandbox, SetInferenceRouteRequest, SetInferenceRouteResponse, ValidatedEndpoint,
