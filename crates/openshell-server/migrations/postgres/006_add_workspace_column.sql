...
UPDATE objects SET workspace = 'default'
  ...
  AND object_type IN ('sandbox', 'provider', 'service_endpoint', 'inference_route', 'ssh_session', 'provider_credential_refresh_state', 'policy', 'draft_chunk', 'sandbox_settings');
