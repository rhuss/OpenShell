...
**Decision**: Keep proto packages in the main module (`github.com/NVIDIA/OpenShell/sdk/go`),
...
**Alternatives considered**:
- Separate `github.com/NVIDIA/OpenShell/sdk/go/proto` module: Adds complexity
